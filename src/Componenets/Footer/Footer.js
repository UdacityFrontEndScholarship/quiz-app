		...
		return (
			...
			<footer>
				...
				<div className="row container-fluid text-center">
					...
					<ul className="col-md-10 row" style={{ listStyleType: 'none' }}>
						<li className="col-md" ><a href="#">Contact Us</a></li>
						<li className="col-md"><a href="#">Udacity</a></li>
						<li className="col-md"><a href="#">Github Repos</a></li>
						<li className="col-md"><a href="#">Contributors</a></li>
						<li className="col-md"><a href="#">Send Feedback</a></li>
						<li className="col-md"><a href="#">Privacy Terms</a></li>
					</ul>
